...
<body id="kt_body" class="bg-body">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{ asset('theme/assets/media/illustrations/sigma-1/14.png') }})">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid p-5">
                <!--begin::Logo-->
                <a href="#" class="mb-5">
                    <img alt="Logo" src="{{ asset('theme/assets/media/logos/gopal.png') }}" class="h-200px" />
                </a>
                <!--end::Logo-->
                <!--begin::Wrapper-->
                <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form class="form w-100" novalidate="novalidate" method="post" action="{{route('login')}}">@csrf
                        <!--begin::Heading-->
                        <div class="text-center mb-10">
                            ...
                            {{-- <div class="text-gray-400 fw-bold fs-4">New Here?
                                <a href="../../demo10/dist/authentication/layouts/basic/sign-up.html" class="link-primary fw-bolder">Create an Account</a></div> --}}
                            <!--end::Link-->
                        </div>
                        <!--begin::Heading-->
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <div class="d-flex flex-stack mb-2">
                                ...
                                <!--end::Label-->
                                <!--begin::Link-->
                                {{-- <a href="../../demo10/dist/authentication/layouts/basic/password-reset.html" class="link-primary fs-6 fw-bolder">Forgot Password ?</a> --}}
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Input-->
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('row.packing') }}"  class="btn btn-lg btn-active-success w-100 mb-5">
                                <span class="indicator-label">Return To Live Display</span>
                                <span class="indicator-progress">Please wait...
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </a>
                            <!--end::Submit button-->
    ...
    <script src="{{ url('/theme') }}/assets/js/custom/authentication/sign-in/general.js"></script>
