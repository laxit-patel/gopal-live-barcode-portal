        ...
        <div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap">
                ...
                <div class="page-title d-flex flex-column me-5 py-2">
                    <!--begin::Title-->
                    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Plant List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('plant.save') }}" id="kt_modal_add_customer_form"
                                data-kt-redirect="{{ route('plant') }}" method="post">@csrf
                                <!--begin::Modal header-->
                                <div class="modal-header" id="kt_modal_add_customer_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder">Add a Plant</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                                ...
                                <div class="modal-body py-10 px-lg-17">
                                    ...
                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fs-6 fw-bold mb-2">Plant Name</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid"
                                                placeholder="Plant Name" name="plant_name" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('plant.delete', ['id' => $plant->plant_id]) }}"
