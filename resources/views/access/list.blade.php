                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Access Roles</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($roles as $role)
                                    <tr>
                                        ...
                                        <!--begin::Action=-->
                                        <td class="text-end">
                                            <a href="{{ route('access.view',$role->role_id) }}" 
                                            class="btn btn-sm btn-hover-scale btn-success "
                                            data-bs-toggle="tooltip" data-bs-placement="left" title="View Line Access"
                                            ><span class="svg-icon svg-icon-1">Access</span></a>
