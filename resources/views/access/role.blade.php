    ...
    <div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-5 py-2">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Role Management</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div id="" class="card">
                ...
                <div class="card-body p-4">
                    <!--begin::Actions-->
                    <form action="{{route('access.role.create')}}" class="w-100" method="post">@csrf
                        ...
                        <div class="me-n7 pe-7">
                            ...
                            <div class="fv-row mb-7 w-50">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="Role Name" name="role" value="" />
                                <!--end::Input-->
                            </div>
